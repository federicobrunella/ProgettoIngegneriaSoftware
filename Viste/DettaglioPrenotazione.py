...
class VistaDettaglioPrenotazione(QWidget):
    def __init__(self, id, callback=None, parent=None):
        ...
        self.labelNumPedana.setText(prenotazione.numPedana)
        self.label_3.setText("Ora Fine:")
        self.label_11.setText("ID Prenotante:")
        self.pushButton.setText("Ok")
        self.labelIDPrenotazione.setText(prenotazione.id)
        ...
        self.labelIDPrenotante.setText(prenotazione.idPrenotante)
